...
class ParquetSource(FilesSources):
    ...
    def check_for_new_files(self):
        ...
        new_files = [
            ...
            if file not in self.previous_files and file.endswith(".parquet")
        ]
    ...
    def get_data(self):
        # Implement getting data from parquet files in the specified folder
        data_frames = []
