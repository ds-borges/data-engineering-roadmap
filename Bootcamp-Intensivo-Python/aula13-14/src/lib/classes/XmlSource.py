...
class XmlSource(FilesSources):
    def create_path(self):
        current_directory = os.getcwd()
        self.folder_path = os.path.join(current_directory, "data", "xml_files")
    ...
    def check_for_new_files(self):
        ...
        new_files = [
            ...
            if file not in self.previous_files and file.endswith(".xml")
        ]
        ...
        if new_files:
            ...
            print("No new XML files detected.")
            self.get_data()

    def get_data(self):
        # Implement getting data from XML files in the specified folder
        data_frames = []
        for file_path in self.previous_files:
            try:
                ...
                print("An error occurred while reading the XML file:", e)
        if data_frames:
